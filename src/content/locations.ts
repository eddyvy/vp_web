...
export const locationsContent: Translation<LocationsContent> = {
  en: {
    ...
    text1:
      'Mallorca is one of the favorite destinations all over the world to celebrate the dreamed wedding.',
    text2:
      'No wonder why…This beautiful island offers absolutely everything you are looking for.',
    text3:
      'Since small romantic coves to the most welcoming mountain corner, you will discover the beauty on this island.',
    text4:
      'We have venues of all styles that will make you fall in love at first sight and want to stay there forever.',
    text5:
      'Your wedding location will set the whole history of modeling your big day.',
    text6:
    ...
    text9:
      'We have no doubt that we will present you the space that characterizes you and makes you fall in love.',
    button: 'Contact us',
  ...
  es: {
    ...
    text1:
      'Mallorca es uno de los destinos preeferidos alrededor del mundo para celebrar la boda soñada.',
    text2:
