      ...
      <div className="pagePadding mobilePaddingTop">
        ...
        <ul>
          <li>
            ...
            this Disclaimer) refers to V&amp;P Weddings and Events.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to V&amp;P Weddings and Events,
            accessible from{' '}
            <a
              href="https://vpevents.com"
