...
export const CookiesPolicy: FC<PageProps> = (pageProps) => {
  ...
  return (
    <PageLayout {...pageProps}>
      <Head>
        <title>V&P | Cookies Policy</title>
      </Head>
      <div className='pagePadding mobilePaddingTop'>
        <h1>Cookies Policy</h1>
        <p>Last updated: July 10, 2022</p>
        <p>This Cookies Policy explains what Cookies are and how We use them. You should read this policy so You can understand what type of cookies We use, or the information We collect using Cookies and how that information is used. This Cookies Policy has been created with the help of the <a href="https://www.privacypolicies.com/cookies-policy-generator/" rel="external nofollow noopener noreferrer" target="_blank">Cookies Policy Generator</a>.</p>
        ...
        <ul>
          <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to V&amp;P Weddings and Events.</li>
          <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
          <li><strong>Website</strong> refers to V&amp;P Weddings and Events, accessible from <a href="https://vpevents.com" rel="external nofollow noopener noreferrer" target="_blank">https://vpevents.com</a></li>
        ...
        <p>You can learn more about cookies: <a href="https://www.privacypolicies.com/blog/cookies/" rel="external nofollow noopener noreferrer" target="_blank">What Are Cookies?</a>.</p>
        <h2>Contact Us</h2>
        <p>If you have any questions about this Cookies Policy, You can contact us:</p>
        <ul>
          <li>By email: vp.weventsgmail.com</li>
        </ul>
      </div>
    </PageLayout>
  )
